...
const ThemeSwitch = (prop) => {
    const [darkMode, setDarkMode] = useState(
        localStorage.getItem('dark-mode') === 'true' || (!('dark-mode' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)
    );
    ...
    return (
        <div className="flex justify-center ml-3">
            <input
                ...
                id="light-switch"
            />
            <label className="relative cursor-pointer p-5" htmlFor="light-switch">
